...
if __name__=='__main__':
    ...
    for result in train_data[:5]:
         print(str(result.id),int(result.quantity))
    ...
    for result in predict_data:
         print(str(result.id),float(result.fact_price),float(result.tag_price),float(result.discount))
